...
class UserProfileResourceIT {
    ...
    public static UserProfile createEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().userName(DEFAULT_USER_NAME).password(DEFAULT_PASSWORD).email(DEFAULT_EMAIL);
        return userProfile;
    }
    ...
    public static UserProfile createUpdatedEntity(EntityManager em) {
        UserProfile userProfile = new UserProfile().userName(UPDATED_USER_NAME).password(UPDATED_PASSWORD).email(UPDATED_EMAIL);
        return userProfile;
    }
    ...
    void putExistingUserProfile() throws Exception {
        ...
        updatedUserProfile.userName(UPDATED_USER_NAME).password(UPDATED_PASSWORD).email(UPDATED_EMAIL);
    ...
    void fullUpdateUserProfileWithPatch() throws Exception {
        ...
        partialUpdatedUserProfile.userName(UPDATED_USER_NAME).password(UPDATED_PASSWORD).email(UPDATED_EMAIL);
